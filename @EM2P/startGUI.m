...
pos_btn_ca_ahead = [pos_btn_auto_del(1)+w1_, pos_btn_auto_del(2), w2_, h1_];
...
pos_btn_rate_plus = [pos_btn_confidence(1)+ 3*w2_, pos_btn_confidence(2), w2_, h1_];
pos_edit_confidence = pos_btn_rate_plus + [w2_+dw1_, 0, 0, 0];
pos_btn_rate_minus = pos_edit_confidence + [w2_+dw1_, 0, 0, 0];
pos_btn_delete = pos_btn_rate_minus + [w2_+dw1_, 0, 2*w2_, 0]; 
...
btn_zoomout = uicontrol(handles.fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_auto_init = uicontrol(handles.fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_auto_init, 'string', 'add EM', 'backgroundcolor', handles.color_cyan,...
...
handles.edit_confidence = uicontrol(handles.fig_main, 'style', 'edit', 'units', 'pixels', ...
    'position', pos_edit_confidence, 'string', '5', 'fontweight', 'bold',...
    'callback', 'cb_edit_confidence;');
handles.btn_rate_plus = uicontrol(handles.fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_rate_plus, 'string', '+', ...
    'callback', 'cb_btn_rate_plus;');
handles.btn_rate_minus = uicontrol(handles.fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_rate_minus, 'string', '-', ...
    'callback', 'cb_btn_rate_minus;');
