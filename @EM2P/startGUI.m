...
% choose scan id
pos_text_scan = pos_btn_load_video + [w1_+dw3_, 0, 0, 0];
...
pos_btn_mark_delete = pos_btn_ca_next + [w2_+dw1_, 0, 2*w2_, 0]; 
pos_btn_delete = pos_btn_mark_delete + [3*w2_+dw1_, 0, 0, 0]; 
...
for m=1:obj.num_slices
    ax_slice{m} = axes('parent', fig_main, 'units', 'pixels','box', 'on', ...
        'position', pos_ax_slice{m}, 'ytick', [], 'xtick', []);
    ax_corr{m} = axes('parent',fig_main, 'units', 'pixels','box', 'on', ...
        'position', pos_ax_corr{m}, 'ytick', [], 'xtick', []);
    ax_em{m} = axes('parent',fig_main, 'units', 'pixels', 'box', 'on', ...
...
%% load button
handles.btn_load_ca = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%% EM blurring
handles.text_blur = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_text_blur, 'string', 'z blur', 'fontsize', font_size, ...
    'fontweight', 'bold', 'backgroundcolor', handles.color_gray);
handles.edit_blur = uicontrol(fig_main, 'style', 'edit', 'units', 'pixels', ...
    'position', pos_edit_blur, 'string', num2str(obj.em_zblur), 'fontweight', 'bold',...
    'callback', 'cb_edit_blur;');
handles.btn_blur_left = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_blur_left, 'string', '<<', ...
    'callback', 'cb_btn_blur_left;');
handles.btn_blur_right = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_blur_right, 'string', '>>', ...
    'callback', 'cb_btn_blur_right;');

handles.btn_load_em = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%% summary statistics
% buttons
handles.btn_pick = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_cn = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_pnr = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%
handles.btn_max = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%
handles.btn_mean = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%
handles.btn_noise = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%% zoom-in & zoom-out
handles.btn_zoomin = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
btn_zoomout = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
%% initialize CNMF
handles.btn_init_cnmf = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_auto_init = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_auto_init, 'string', 'auto init.', 'backgroundcolor', handles.color_gray,...
    'fontsize', font_size, 'fontweight', 'bold', 'callback', 'ease_auto_init;');

handles.btn_manual_init = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_manual_init, 'string', 'semi-auto', 'backgroundcolor', handles.color_gray,...
    'fontsize', font_size, 'fontweight', 'bold', 'callback', 'ease_manual_init;');

handles.btn_load_init = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_ca_ahead = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_ca_ahead, 'string', '<<',...
    'callback', 'cell_id = max(1, cell_id-1); ease_show_2p_neuron;');
handles.text_cell_id = uicontrol(fig_main, 'style', 'edit', 'units', 'pixels', ...
...
handles.btn_ca_next = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_ca_next, 'string', '>>',...
    'callback', 'cell_id=cell_id+1; ease_show_2p_neuron;');

handles.btn_mark_delete = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_mark_delete, 'string', 'mark del.', 'fontweight', 'bold',...
    'callback', 'ease_mark_deletion;');
handles.btn_delete = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_delete, 'string', 'delete', 'fontweight', 'bold',...
    'callback', 'neuron.delete(find(ease_ind_delete)); clear ease_ind_delete; scores=neuron.scores;');

%% initialize a component given a seed pixel
handles.btn_init_seed = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_match_em = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
...
handles.btn_em_ahead = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_em_ahead, 'string', '<<',...
    'callback', 'em_rank = max(1, em_rank-1); ease_check_match;');
handles.text_em_current = uicontrol(fig_main, 'style', 'edit', 'units', 'pixels', ...
...
handles.btn_em_next = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
    'position', pos_btn_em_next, 'string', '>>',...
    'callback', 'em_rank=em_rank+1; ease_check_match;');
handles.check_em_only = uicontrol(fig_main, 'style', 'checkbox', 'units', 'pixels', ...
    'position', pos_check_em,...
    'callback', 'ease.show_em_only= logical(get(gco, ''value'')); cb_btn_em_only;');
handles.btn_em_only = uicontrol(fig_main, 'style', 'pushbutton', 'units', 'pixels', ...
